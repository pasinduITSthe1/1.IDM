...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:40
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\products\prices.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f29c87c312_28472208',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '01453c7d177dc51ce5a72f17da9f9e5565ed8608' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\products\\prices.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f29c87c312_28472208 (Smarty_Internal_Template $_smarty_tpl) {
...
echo sprintf($_smarty_tpl->tpl_vars['priceDisplayPrecisionFormat']->value,$_prefixVariable27);?>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The sum of wholesale prices of the room types in the pack is %s%s%s','sprintf'=>array($_smarty_tpl->tpl_vars['currency']->value->prefix,$_prefixVariable28,$_smarty_tpl->tpl_vars['currency']->value->suffix)),$_smarty_tpl ) );?>
</p><?php }?>
		</div>
	</div>
	<div class="form-group">
...
?></span></div>
		<label class="control-label col-lg-2" for="priceTE">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The pre-tax retail price is the price for which you intend sell this room type to your customers. It should be higher than the pre-tax operating cost: the difference between the two will be your margin.'),$_smarty_tpl ) );?>
"><?php if (!$_smarty_tpl->tpl_vars['country_display_tax_label']->value || $_smarty_tpl->tpl_vars['tax_exclude_taxe_option']->value) {
...
echo sprintf('%.6f',$_prefixVariable29);?>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The sum of prices of the room types in the pack is %s%s%s','sprintf'=>array($_smarty_tpl->tpl_vars['currency']->value->prefix,$_prefixVariable30,$_smarty_tpl->tpl_vars['currency']->value->suffix)),$_smarty_tpl ) );?>
</p><?php }?>
	</div>
...
?></span></div>
	...
	<!-- by webkul -->
	<?php if ((isset($_smarty_tpl->tpl_vars['WK_ALLOW_ADVANCED_PAYMENT']->value)) && $_smarty_tpl->tpl_vars['WK_ALLOW_ADVANCED_PAYMENT']->value) {?>
		<div class="form-group">
			<div class="col-lg-1"><span class="pull-right"><?php $_smarty_tpl->_subTemplateRender("file:controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('field'=>"price",'type'=>"price"), 0, true);
?></span></div>
...
echo sprintf('%.6f',$_prefixVariable31);
}?>"/>
										</div>
									</div>
								</div>
...
<div class="panel">
	<h3><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Advanced Price Rules'),$_smarty_tpl ) );?>
</h3>
	<div class="alert alert-info">
		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'You can set advanced price rules by visiting '),$_smarty_tpl ) );?>

		<a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminHotelFeaturePricesSettings');?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'create advanced price rules.'),$_smarty_tpl ) );?>
</a>
	</div>
		...
		<table class="table">
			<thead>
				<tr>
					...
					<th><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Rule Name'),$_smarty_tpl ) );?>
</th>
...
?>
						<tr>
							...
							<td>
								<?php if ($_smarty_tpl->tpl_vars['featurePlan']->value['impact_way'] == HotelRoomTypeFeaturePricing::IMPACT_WAY_DECREASE) {?>
							...
							<td>
								<?php if ($_smarty_tpl->tpl_vars['featurePlan']->value['impact_type'] == HotelRoomTypeFeaturePricing::IMPACT_TYPE_PERCENTAGE) {?>
							...
							<td>
								<?php if ($_smarty_tpl->tpl_vars['featurePlan']->value['impact_type'] == HotelRoomTypeFeaturePricing::IMPACT_TYPE_PERCENTAGE) {?>
									<?php echo round((float) $_smarty_tpl->tpl_vars['featurePlan']->value['impact_value'], (int) 2, (int) 1);?>
%
								<?php } else { ?>
							...
							<td>
								<?php if ($_smarty_tpl->tpl_vars['featurePlan']->value['date_selection_type'] == HotelRoomTypeFeaturePricing::DATE_SELECTION_TYPE_RANGE) {?>
				...
				<?php } else { ?>
					<tr>
						<td class="text-center" colspan="6">
							<i class="icon-warning-sign"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No advanced price rules.'),$_smarty_tpl ) );?>
...
" id="customer" autocomplete="off" />
			...
			<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['combinations']->value) != 0) {?>
			<div class="form-group">
