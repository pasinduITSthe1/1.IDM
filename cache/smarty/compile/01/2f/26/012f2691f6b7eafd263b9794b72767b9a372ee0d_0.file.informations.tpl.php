...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:39
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\products\informations.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f29b6700f1_76801004',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '012f2691f6b7eafd263b9794b72767b9a372ee0d' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\products\\informations.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f29b6700f1_76801004 (Smarty_Internal_Template $_smarty_tpl) {
...
&submitResetproduct&submitFilterproduct=1&productFilter_a!id_category_default=<?php echo $_smarty_tpl->tpl_vars['htl_full_info']->value['id_category'];?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'here.'),$_smarty_tpl ) );?>
	...
	<div class="form-group" id="bed_types_selection">
		<label class="control-label col-sm-3">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Select all bed types available for this room type.'),$_smarty_tpl ) );?>
">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Bed Types'),$_smarty_tpl ) );?>
		...
		<div class="col-sm-5">
			<select name="id_bed_types[]" id="id_bed_types" class="form-control chosen" multiple>
				<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['bed_types_info']->value, 'bed_type_info');
$_smarty_tpl->tpl_vars['bed_type_info']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['bed_type_info']->value) {
$_smarty_tpl->tpl_vars['bed_type_info']->do_else = false;
?>
					<option value="<?php echo $_smarty_tpl->tpl_vars['bed_type_info']->value['id_bed_type'];?>
" <?php if ((isset($_smarty_tpl->tpl_vars['selected_bed_types']->value)) && in_array($_smarty_tpl->tpl_vars['bed_type_info']->value['id_bed_type'],$_smarty_tpl->tpl_vars['selected_bed_types']->value)) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['bed_type_info']->value['name'];?>
</option>
				<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
