...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:13
  from 'C:\wamp64\www\1.IDM\themes\hotel-reservation-theme\order-address-multishipping-products.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f281e6fdd2_52054861',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e76878d03a55f31d5544d426597044052efa97c8' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\themes\\hotel-reservation-theme\\order-address-multishipping-products.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f281e6fdd2_52054861 (Smarty_Internal_Template $_smarty_tpl) {
...
$__foreach_product_60_saved = $_smarty_tpl->tpl_vars['product'];
?>
...
?>
		<?php
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_60_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		</tbody>
	</table>
</div>
<?php $_block_plugin48 = isset($_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin48->addJsDefL(array('name'=>'CloseTxt'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin48->addJsDefL(array('name'=>'CloseTxt'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin49->addJsDefL(array('name'=>'QtyChanged'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin49->addJsDefL(array('name'=>'QtyChanged'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
...
$_block_repeat=true;
echo $_block_plugin50->addJsDefL(array('name'=>'ShipToAnOtherAddress'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin50->addJsDefL(array('name'=>'ShipToAnOtherAddress'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
