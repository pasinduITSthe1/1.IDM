...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:06
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\attribute_generator\content.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f27a4a0058_70935649',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '609a91ef7556703618ea01b2dee3bb8d96bcb478' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\attribute_generator\\content.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f27a4a0058_70935649 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
			<?php ob_start();
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['attrname']->value, ENT_QUOTES, 'UTF-8', true);
...
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_64115303368e4f27a412ca6_23709143', "leadin");
?>
</div>
...
" label="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['attribute_group']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
">
									<?php
...
" title="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['v']->value, ENT_QUOTES, 'UTF-8', true);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <b><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product_name']->value, ENT_QUOTES, 'UTF-8', true);?>
</b></div>
...
?>
					...
					<div class="row">
						<table class="table" style="display:none">
							<thead>
								<tr>
									<th id="tab_h1" class="fixed-width-md"><span class="title_box"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['attribute_group']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</span></th>
				...
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="reference" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product_reference']->value, ENT_QUOTES, 'UTF-8', true);?>
" /></td>
						</tr>
					</tbody>
				</table>
...
<?php }
/* {block "leadin"} */
class Block_64115303368e4f27a412ca6_23709143 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'leadin' => 
  array (
    0 => 'Block_64115303368e4f27a412ca6_23709143',
  ),
);
