...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:15
  from 'C:\wamp64\www\1.IDM\themes\hotel-reservation-theme\order-carrier-advanced.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f2837cf819_80677205',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '28be7b5fe798e7cc8f05ad5840bcbb7611122fb3' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\themes\\hotel-reservation-theme\\order-carrier-advanced.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f2837cf819_80677205 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.count.php','function'=>'smarty_modifier_count',),1=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.explode.php','function'=>'smarty_modifier_explode',),));
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,$_prefixVariable30), ENT_QUOTES, 'UTF-8', true);?>
...
$__foreach_option_64_saved = $_smarty_tpl->tpl_vars['option'];
?>
...
$__foreach_carrier_65_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['carrier']->value['logo']) {?>
                                                                            <img class="order_carrier_logo" src="<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['logo'], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['instance']->name, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
"/>
                                                                        <?php } elseif (!$_smarty_tpl->tpl_vars['option']->value['unique_carrier']) {?>
                                                                            <?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['instance']->name, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>

                                                                            <?php if (!$_smarty_tpl->tpl_vars['carrier']->last) {?> - <?php }?>
                                                                        <?php }?>
                                                                    <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_65_saved;
}
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_66_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
                                                                            <strong><?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['instance']->name, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
</strong>
                                                                        <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_66_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
&nbsp;<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['instance']->delay[$_smarty_tpl->tpl_vars['cookie']->value->id_lang], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
...
if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'(tax incl.)'),$_smarty_tpl ) );
                                                        ...
                                                        <?php if (!$_smarty_tpl->tpl_vars['option']->value['unique_carrier']) {?>
                                                            <table class="delivery_option_carrier<?php if ((isset($_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value])) && $_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value] == $_smarty_tpl->tpl_vars['key']->value) {?> selected<?php }?> resume table table-bordered<?php if ($_smarty_tpl->tpl_vars['option']->value['unique_carrier']) {?> hide<?php }?>">
                                                                <tr>
                                                                    <?php if (!$_smarty_tpl->tpl_vars['option']->value['unique_carrier']) {?>
                                                                        <td rowspan="<?php echo smarty_modifier_count($_smarty_tpl->tpl_vars['option']->value['carrier_list']);?>
...
"<?php if ((isset($_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value])) && $_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value] == $_smarty_tpl->tpl_vars['key']->value) {?> checked="checked"<?php }?> />
                                                                    ...
                                                                    <td class="delivery_option_logo<?php if ($_smarty_tpl->tpl_vars['first']->value['product_list'][0]['carrier_list'][0] == 0) {?> hide<?php }?>">
                                                                        <?php if ($_smarty_tpl->tpl_vars['first']->value['logo']) {?>
                                                                            <img class="order_carrier_logo" src="<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['first']->value['logo'], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['first']->value['instance']->name, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
"/>
                                                                        <?php } elseif (!$_smarty_tpl->tpl_vars['option']->value['unique_carrier']) {?>
                                                                            <?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['first']->value['instance']->name, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
...
" name="id_carrier" />
                                                                        <?php if ((isset($_smarty_tpl->tpl_vars['first']->value['instance']->delay[$_smarty_tpl->tpl_vars['cookie']->value->id_lang]))) {?>
                                                                            ...
                                                                            <?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['first']->value['instance']->delay[$_smarty_tpl->tpl_vars['cookie']->value->id_lang], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
...
$__foreach_product_67_saved = $_smarty_tpl->tpl_vars['product'];
?>
                                                                                <?php if ($_smarty_tpl->tpl_vars['product']->index == 4) {?>
                                                                                    <acronym title="
																<?php }?>
																<?php if ($_smarty_tpl->tpl_vars['product']->index >= 4) {
echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['product']->value['name'], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);
if ((isset($_smarty_tpl->tpl_vars['product']->value['attributes'])) && $_smarty_tpl->tpl_vars['product']->value['attributes']) {
echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['product']->value['attributes'], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);
}
...
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_67_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
}?></td><td rowspan="<?php echo smarty_modifier_count($_smarty_tpl->tpl_vars['option']->value['carrier_list']);?>
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_68_saved = $_smarty_tpl->tpl_vars['carrier'];
if ($_smarty_tpl->tpl_vars['carrier']->iteration != 1) {?><tr><td class="delivery_option_logo<?php if ($_smarty_tpl->tpl_vars['carrier']->value['product_list'][0]['carrier_list'][0] == 0) {?> hide<?php }?>"><?php if ($_smarty_tpl->tpl_vars['carrier']->value['logo']) {?><img class="order_carrier_logo" src="<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['logo'], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['instance']->name, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
"/><?php } elseif (!$_smarty_tpl->tpl_vars['option']->value['unique_carrier']) {
echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['instance']->name, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);
...
" name="id_carrier" /><?php if ((isset($_smarty_tpl->tpl_vars['carrier']->value['instance']->delay[$_smarty_tpl->tpl_vars['cookie']->value->id_lang]))) {?><i class="icon-info-sign"></i><?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['carrier']->value['instance']->delay[$_smarty_tpl->tpl_vars['cookie']->value->id_lang], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
&nbsp;<?php if (count($_smarty_tpl->tpl_vars['first']->value['product_list']) <= 1) {?>(<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'For this product:'),$_smarty_tpl ) );
} else { ?>(<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'For these products:'),$_smarty_tpl ) );
}?>
                                                                                    <?php
...
$_smarty_tpl->tpl_vars['product']->index++;
$_smarty_tpl->tpl_vars['product']->last = $_smarty_tpl->tpl_vars['product']->iteration === $_smarty_tpl->tpl_vars['product']->total;
$__foreach_product_69_saved = $_smarty_tpl->tpl_vars['product'];
?>
                                                                                        <?php if ($_smarty_tpl->tpl_vars['product']->index == 4) {?>
                                                                                            <acronym title="
																	<?php }?>
...
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_69_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
}?></td></tr><?php }
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_68_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></table><?php }?></div></div> <!-- end delivery_option --><?php
$_smarty_tpl->tpl_vars['option'] = $__foreach_option_64_saved;
}
...
$_smarty_tpl->_assignInScope('errors', smarty_modifier_explode(' ',''));?><p class="alert alert-warning" id="noCarrierWarning"><?php
...
$__foreach_address_70_saved = $_smarty_tpl->tpl_vars['address'];
...
$_smarty_tpl->tpl_vars['address'] = $__foreach_address_70_saved;
}
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,"step=1&back=".((string)$_smarty_tpl->tpl_vars['back']->value).$_prefixVariable31), ENT_QUOTES, 'UTF-8', true);?>
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,"step=1".$_prefixVariable32), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Previous'),$_smarty_tpl ) );?>
" class="button-exclusive btn btn-default">
                                <i class="icon-chevron-left"></i>
                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Continue shopping'),$_smarty_tpl ) );?>
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,$_prefixVariable33), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Previous'),$_smarty_tpl ) );?>
" class="button-exclusive btn btn-default">
                            <i class="icon-chevron-left"></i>
                            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Continue shopping'),$_smarty_tpl ) );?>
...
$_block_repeat=true;
echo $_block_plugin64->addJsDefL(array('name'=>'txtProduct'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin64->addJsDefL(array('name'=>'txtProduct'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin65->addJsDefL(array('name'=>'txtProducts'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin65->addJsDefL(array('name'=>'txtProducts'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
...
$_block_repeat=true;
echo $_block_plugin66->addJsDefL(array('name'=>'msg_order_carrier'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin66->addJsDefL(array('name'=>'msg_order_carrier'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
