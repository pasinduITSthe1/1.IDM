...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:36
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\products\configuration.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f2989deca1_11915796',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9d897338d81f0097e6b77111fc93d33de5cb8cbb' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\products\\configuration.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f2989deca1_11915796 (Smarty_Internal_Template $_smarty_tpl) {
...
">
                        ...
                        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayHotelRoomListTableHeaderColumn'),$_smarty_tpl ) );?>
				...
				<tbody>
					<?php if ((isset($_POST['rooms_info'])) && is_array($_POST['rooms_info']) && count($_POST['rooms_info']) && !(isset($_smarty_tpl->tpl_vars['bulk_delete_rooms']->value))) {?>
...
">
                                <td class="center">
                                    <input type="checkbox" <?php if ((isset($_smarty_tpl->tpl_vars['room_info']->value['id']))) {?>value="<?php echo $_smarty_tpl->tpl_vars['room_info']->value['id'];?>
"<?php } else { ?>disabled<?php }?> name="selected_room_ids[]">
								</td>
...
if ($_smarty_tpl->tpl_vars['room_info']->value['id_status'] == $_prefixVariable25) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['room_stauts']->value['status'];?>
</option>
										<?php
}
...
" <?php if ($_smarty_tpl->tpl_vars['room_info']->value['id_status'] == $_smarty_tpl->tpl_vars['rm_status']->value['STATUS_TEMPORARY_INACTIVE']['id']) {?>value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['room_info']->value['disable_dates_json'], ENT_QUOTES, 'UTF-8', true);?>
"<?php }?>>
								</td>
                                                                <?php if ((isset($_smarty_tpl->tpl_vars['room_info']->value['id']))) {?>
                                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayHotelRoomListTableRowColumn','index'=>$_smarty_tpl->tpl_vars['key']->value,'id_room'=>$_smarty_tpl->tpl_vars['room_info']->value['id']),$_smarty_tpl ) );?>

                                <?php } else { ?>
                                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayHotelRoomListTableRowColumn','index'=>$_smarty_tpl->tpl_vars['key']->value),$_smarty_tpl ) );?>

                                <?php }?>
								<td class="col-sm-1 center">
									<?php if ((isset($_smarty_tpl->tpl_vars['room_info']->value['id']))) {?>
                                        <?php if ((isset($_smarty_tpl->tpl_vars['room_info']->value['booked_dates'])) && json_decode($_smarty_tpl->tpl_vars['room_info']->value['booked_dates'])) {?>
                                            <input type="hidden" class="booked-dates" name="<?php echo ($_smarty_tpl->tpl_vars['var_name_room_info']->value).('[booked_dates]');?>
" value='<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['room_info']->value['booked_dates'], ENT_QUOTES, 'UTF-8', true);?>
'>
...
" value="">
                                ...
                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayHotelRoomListTableRowColumn','index'=>$_smarty_tpl->tpl_vars['k']->value),$_smarty_tpl ) );?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="#" id="bulk-update-rooms-button" class="bulkUpdateRoomModal" data-toggle="modal" data-target="#bulkUpdateRoomModal" type="button" data-size="s" data-style="expand-right" disabled>
                                    <i class="icon-edit"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Update selection'),$_smarty_tpl ) );?>

                                </a>
                            </li>
                            <li>
                                <a href="#" id="bulk-delete-rooms-button">
                                    <i class="icon-trash"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delete selection'),$_smarty_tpl ) );?>
                            ...
                            <li>
                                <a id="bulk-create-rooms-button" class="bulkCreateRoomModal" data-toggle="modal" data-target="#bulkCreateRoomModal" type="button" data-size="s" data-style="expand-right">
                                    <i class="icon-plus"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Create Rooms'),$_smarty_tpl ) );?>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="icon-calendar"></i>&nbsp; <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Bulk Update Rooms'),$_smarty_tpl ) );?>
</h4>
			</div>
...
?>
                                <option value="<?php echo $_smarty_tpl->tpl_vars['room_stauts']->value['id'];?>
"><?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['room_stauts']->value['status'], 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
</option>
                            <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				...
				<div class="from-group table-responsive-row clearfix" style="display:none;">
                    <div class="rooms-disable-dates-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Disable Dates'),$_smarty_tpl ) );?>
</div>
                    <table class="table rooms-disable-dates">
                        <thead>
                            <tr class="nodrag nodrop">
                                <th class="col-sm-1 center">
                                    <div><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Date From'),$_smarty_tpl ) );?>
</span>
                                </th>
                                <th class="col-sm-2 center">
                                    <span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Date To'),$_smarty_tpl ) );?>
			    ...
			    <div class="modal-footer">
				    <button type="button" class="btn btn-default" name="submitBulkUpdateRooms"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Submit'),$_smarty_tpl ) );?>
</button>
			    </div>
		    </div>
	    </div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="icon-calendar"></i>&nbsp; <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Bulk Create Rooms'),$_smarty_tpl ) );?>
</h4>
			</div>
			<div class="modal-body padding-top-20">
				<div class="text-left errors-wrap" style="display: none;"></div>
                <div class="form-group">
                    <label class="control-label col-lg-3">
                        <span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Room prefix'),$_smarty_tpl ) );?>
</span>
                    </label>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label class="control-label col-lg-3">
                        <span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Starting Room No.'),$_smarty_tpl ) );?>
</span>
                    </label>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label class="control-label required col-lg-3">
                        <span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Number of Rooms'),$_smarty_tpl ) );?>
</span>
                    </label>
                    <div class="col-lg-6">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			    ...
			    <div class="modal-footer">
				    <button type="button" class="btn btn-default" name="submitBulkCreateRooms"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Submit'),$_smarty_tpl ) );?>
</button>
			    </div>
		    </div>
	    </div>
                ...
                if (bookedDates.length) {
                    ...
                    $(bookedDates).each(function() {
                        $('#room-dates-modal .room-booked-dates-table tbody').append(`<tr>
                            <td><a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminOrders'), ENT_QUOTES, 'UTF-8', true);?>
...
";
                ...
                html += '</td>';
                html += '<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayHotelRoomListTableRowColumn'),$_smarty_tpl ) );?>
';
...
");
        ...
        const BulkUpdateRoomModal = {
            ...
            submitBulkDelete: function() {
                if (confirm("<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delete selected rooms?'),$_smarty_tpl ) );?>
")) {
