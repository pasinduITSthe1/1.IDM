...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:46
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f2a2ebcd71_81453863',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '83a2d244cad8cf6c6c4b4ad5efcb8d97ada0f7ac' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\header.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f2a2ebcd71_81453863 (Smarty_Internal_Template $_smarty_tpl) {
...
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Show all messages'),$_smarty_tpl ) );?>
					...
					<?php }?>
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayBackOfficeTopNotificaiton'),$_smarty_tpl ) );?>
...
if ($_smarty_tpl->tpl_vars['link']->value->matchQuickLink($_prefixVariable40)) {
...
>
				...
				<ul id="header_employee_box">
					<?php if ((isset($_smarty_tpl->tpl_vars['upgrade_info']->value->update_available)) && $_smarty_tpl->tpl_vars['upgrade_info']->value->update_available > 0) {?>
						<li class="hidden-md hidden-sm hidden-xs"><a href="<?php echo $_smarty_tpl->tpl_vars['upgrade_info']->value->upgrade_url;?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'QloApps Update Availabe:'),$_smarty_tpl ) );?>
 <?php echo $_smarty_tpl->tpl_vars['upgrade_info']->value->latest_availabe;?>
</a></li>
					<?php }?>
...
&amp;updateemployee" class="dropdown-toggle" data-toggle="dropdown">
...
<?php } else { ?>
	<body<?php if ((isset($_smarty_tpl->tpl_vars['lite_display']->value)) && $_smarty_tpl->tpl_vars['lite_display']->value) {?> class="ps_back-office display-modal"<?php }?>>
		<div id="main">
			<div id="content" class="<?php if (!$_smarty_tpl->tpl_vars['bootstrap']->value) {?>nobootstrap<?php } else { ?>bootstrap<?php }?>">
<?php }?>
				<div id="page-loader"><span><i class="icon-refresh icon-spin icon-fw"></i></span></div><?php }
}
