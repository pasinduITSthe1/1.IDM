...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:12
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\customer_threads\helpers\view\view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f280e794e0_32683594',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '24cf3e0379e31096306348000ef4b58b042b0627' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\customer_threads\\helpers\\view\\view.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f280e794e0_32683594 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_125030487968e4f280b09797_34735188', "override_tpl");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "helpers/view/view.tpl");
}
/* {block "override_tpl"} */
class Block_125030487968e4f280b09797_34735188 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'override_tpl' => 
  array (
    0 => 'Block_125030487968e4f280b09797_34735188',
  ),
);
...
: <span class="badge">#<?php echo intval($_smarty_tpl->tpl_vars['id_customer_thread']->value);?>
		...
		<?php if ((isset($_smarty_tpl->tpl_vars['thread']->value->id_customer)) && $_smarty_tpl->tpl_vars['thread']->value->id_customer) {?>
			<a class="pull-right" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers'), ENT_QUOTES, 'UTF-8', true);?>
...
<small>(<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['customer']->value->email, ENT_QUOTES, 'UTF-8', true);?>
)</small>
			</a>
		<?php }?>
	</div>
...
?>
				<button class="btn btn-default" name="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['action']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo intval($_smarty_tpl->tpl_vars['action']->value['value']);?>
">
					<?php if ((isset($_smarty_tpl->tpl_vars['action']->value['icon']))) {?><i class="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['action']->value['icon'], ENT_QUOTES, 'UTF-8', true);?>
"></i><?php }
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<div class="row">
		<div class="message-item-initial media">
			...
			<div class="media-body">
				<div class="row">
					<div class="col-sm-6">
					<?php if ((isset($_smarty_tpl->tpl_vars['thread']->value->user_name)) && trim($_smarty_tpl->tpl_vars['thread']->value->user_name)) {?>
						<h2>
							<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['thread']->value->user_name, ENT_QUOTES, 'UTF-8', true);?>
 <small>(<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['thread']->value->email, ENT_QUOTES, 'UTF-8', true);?>
)</small>
						</h2>
					<?php } else { ?>
						<h2><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['thread']->value->email, ENT_QUOTES, 'UTF-8', true);?>
</h2>
					<?php }?>
					<?php if ((isset($_smarty_tpl->tpl_vars['thread']->value->phone)) && trim($_smarty_tpl->tpl_vars['thread']->value->phone) != '') {?>
						<p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Phone:'),$_smarty_tpl ) );?>
 <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['thread']->value->phone, ENT_QUOTES, 'UTF-8', true);?>
</p>
					<?php }?>
 ...
 </span><span class="badge"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['contact']->value, ENT_QUOTES, 'UTF-8', true);?>
</span>
					<?php }?>
					</div>
					<?php if ((isset($_smarty_tpl->tpl_vars['customer']->value->email)) && $_smarty_tpl->tpl_vars['customer']->value->email == $_smarty_tpl->tpl_vars['thread']->value->email) {?>
						<div class="col-sm-6">
							<p>
							<?php if ($_smarty_tpl->tpl_vars['count_ok']->value) {?>
								<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'[1]%1$d[/1] order(s) validated, total amount paid [2]%2$s[/2]','sprintf'=>array($_smarty_tpl->tpl_vars['count_ok']->value,$_smarty_tpl->tpl_vars['total_ok']->value),'tags'=>array('<span class="badge">','<span class="badge badge-success">')),$_smarty_tpl ) );?>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Customer since: %s",'sprintf'=>array($_prefixVariable4)),$_smarty_tpl ) );?>
</p>
						</div>
					<?php }?>
				</div>
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['customer']->value->firstname, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['customer']->value->lastname, ENT_QUOTES, 'UTF-8', true);?>
...
" alt=""><?php }?></span>
			...
			<div class="media-body">
				<textarea cols="30" rows="7" name="reply_message"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['PS_CUSTOMER_SERVICE_SIGNATURE']->value, ENT_QUOTES, 'UTF-8', true);?>
</textarea>
			</div>
		</div>
	</div>
	<div class="panel-footer">
		...
		-->
		<button class="btn btn-default" name="submitReplyAndClose"><i class="process-icon-reply-all"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Reply And Close'),$_smarty_tpl ) );?>
</button>
		<button class="btn btn-default pull-right" name="submitReply"><i class="process-icon-mail-reply"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Reply And Open'),$_smarty_tpl ) );?>
</button>
		<button class="btn btn-default pull-right" name="submitReplyAsPrivate"><i class="process-icon-lock"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add Private Message'),$_smarty_tpl ) );?>
</button>
