...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:18
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\modules\page.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f286f2e888_44198308',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7f25e7a67f26925f74b8f46ef79013af819f8fe1' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\modules\\page.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f286f2e888_44198308 (Smarty_Internal_Template $_smarty_tpl) {
...
&nbsp;<span class="badge <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['module_alerts']->value)) {?>badge-danger<?php } else { ?>badge-success<?php }?>"><?php echo smarty_modifier_count($_smarty_tpl->tpl_vars['module_alerts']->value);?>
</span></a></li>
...
&nbsp;<span class="badge <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['upgrade_available']->value)) {?>badge-danger<?php } else { ?>badge-success<?php }?>"><?php echo smarty_modifier_count($_smarty_tpl->tpl_vars['upgrade_available']->value);?>
</span></a></li>
	</ul>
	<div class="tab-content">
		<div id="mod-alert" class="tab-pane">
		<hr>
			<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['module_alerts']->value)) {?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<div id="mod-update" class="tab-pane">
			<hr>
			<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['upgrade_available']->value)) {?>
...
?>
						<li><a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentIndex']->value, ENT_QUOTES, 'UTF-8', true);?>
...
<div id="module_install" class="row" style="<?php if (!(isset($_POST['downloadflag']))) {?>display: none;<?php }?>">
	<div class="panel col-lg-12">
		<form id="module_install_form" action="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentIndex']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
...
" type="text" value="" name="moduleQuicksearch" id="moduleQuicksearch" autocomplete="off" />
				...
				<a class="categoryModuleFilterLink list-group-item <?php if ((isset($_smarty_tpl->tpl_vars['categoryFiltered']->value['favorites']))) {?>active<?php }?>" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentIndex']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;filterCategory=favorites" id="filter_favorite">
 ...
 <span id="favorite-count" class="badge pull-right"><?php echo $_smarty_tpl->tpl_vars['nb_modules_favorites']->value;?>
				...
				<a class="categoryModuleFilterLink list-group-item <?php if (count($_smarty_tpl->tpl_vars['categoryFiltered']->value) <= 0) {?>active<?php }?>" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentIndex']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
...
?>
					<a class="categoryModuleFilterLink list-group-item <?php if ((isset($_smarty_tpl->tpl_vars['categoryFiltered']->value[$_smarty_tpl->tpl_vars['module_category_key']->value]))) {?>active<?php }?>" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentIndex']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
