...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:07
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\carts\helpers\view\view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f27bdaa890_14342281',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5653d104201ced08fcab5a09326cbd7415499e23' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\carts\\helpers\\view\\view.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f27bdaa890_14342281 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_95953130868e4f27b7349a0_63181517', "override_tpl");
?>
...
/* {block "override_tpl"} */
class Block_95953130868e4f27b7349a0_63181517 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'override_tpl' => 
  array (
    0 => 'Block_95953130868e4f27b7349a0_63181517',
  ),
);
...
"><i class="icon-envelope"></i> <?php echo $_smarty_tpl->tpl_vars['customer']->value->email;?>
				...
				<h4 style="padding-top:10px">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Customer Name'),$_smarty_tpl ) );?>
:
					<a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers'), ENT_QUOTES, 'UTF-8', true);?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['customer']->value->lastname;?>
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-lg-3"><p class="form-control-static"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0], array( array('price'=>Tools::convertPrice(floatval($_smarty_tpl->tpl_vars['customer_stats']->value['total_orders']),$_smarty_tpl->tpl_vars['currency']->value),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl ) );?>
</p></div>
					</div>
				</div>
			<?php } else { ?>
...
?>
					<h2><a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminOrders'), ENT_QUOTES, 'UTF-8', true);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0], array( array('date'=>$_smarty_tpl->tpl_vars['cart_order']->value['date_add']),$_smarty_tpl ) );?>
			...
			<?php } else { ?>
				...
				<?php if ($_smarty_tpl->tpl_vars['customer']->value->id && !$_smarty_tpl->tpl_vars['hotel_products']->value && !$_smarty_tpl->tpl_vars['standalone_products']->value) {?>
...
&amp;updateproduct">
						...
						<td><a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminAddHotel'), ENT_QUOTES, 'UTF-8', true);?>
...
&amp;updatehtl_branch_info"><?php echo $_smarty_tpl->tpl_vars['room']->value['room_type_info']['hotel_name'];?>
						...
						<?php $_smarty_tpl->_assignInScope('is_full_date', ($_smarty_tpl->tpl_vars['show_full_date']->value && (smarty_modifier_date_format($_smarty_tpl->tpl_vars['room']->value['date_from'],'%D') == smarty_modifier_date_format($_smarty_tpl->tpl_vars['room']->value['date_to'],'%D'))));?>
						<td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0], array( array('date'=>$_smarty_tpl->tpl_vars['room']->value['date_from'],'full'=>$_smarty_tpl->tpl_vars['is_full_date']->value),$_smarty_tpl ) );?>
 - <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0], array( array('date'=>$_smarty_tpl->tpl_vars['room']->value['date_to'],'full'=>$_smarty_tpl->tpl_vars['is_full_date']->value),$_smarty_tpl ) );?>
</td>
						<td>
							<span>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Child'),$_smarty_tpl ) );
						...
						<td>
							<?php if (((isset($_smarty_tpl->tpl_vars['room']->value['selected_demands'])) && $_smarty_tpl->tpl_vars['room']->value['selected_demands']) || ((isset($_smarty_tpl->tpl_vars['room']->value['selected_services'])) && $_smarty_tpl->tpl_vars['room']->value['selected_services'])) {?>
								<a href="#" data-toggle="modal" data-target="#rooms_type_extra_demands_<?php echo $_smarty_tpl->tpl_vars['room']->value['id'];?>
">
									<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0], array( array('price'=>htmlspecialchars((string)($_smarty_tpl->tpl_vars['room']->value['demand_price']+$_smarty_tpl->tpl_vars['room']->value['additional_service_price']+$_smarty_tpl->tpl_vars['room']->value['additional_services_auto_add_price']), ENT_QUOTES, 'UTF-8', true),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl ) );?>
						...
						<td class="text-right">
							<?php if (((isset($_smarty_tpl->tpl_vars['room']->value['selected_demands'])) && $_smarty_tpl->tpl_vars['room']->value['selected_demands']) || ((isset($_smarty_tpl->tpl_vars['room']->value['selected_services'])) && $_smarty_tpl->tpl_vars['room']->value['selected_services'])) {?>
								<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0], array( array('price'=>htmlspecialchars((string)($_smarty_tpl->tpl_vars['room']->value['amt_with_qty']+$_smarty_tpl->tpl_vars['room']->value['additional_services_auto_add_price']+$_smarty_tpl->tpl_vars['room']->value['demand_price']+$_smarty_tpl->tpl_vars['room']->value['additional_service_price']), ENT_QUOTES, 'UTF-8', true),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl ) );?>

							<?php } else { ?>
								<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0], array( array('price'=>htmlspecialchars((string)$_smarty_tpl->tpl_vars['room']->value['amt_with_qty'], ENT_QUOTES, 'UTF-8', true),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl ) );?>
																					...
																					<div class="col-xs-6">
																						<div class="row">
																							<div class="col-xs-10 demand_adv_option_block">
																								<p>
																									<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['roomDemand']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<br>
																					...
																					<div class="col-xs-6">
																						<p><span class="pull-right extra_demand_option_price">
																							<?php if ((isset($_smarty_tpl->tpl_vars['roomDemand']->value['adv_option'])) && $_smarty_tpl->tpl_vars['roomDemand']->value['adv_option']) {?>
																								<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0], array( array('price'=>htmlspecialchars((string)$_smarty_tpl->tpl_vars['roomDemand']->value['adv_option'][$_smarty_tpl->tpl_vars['demand']->value['id_option']]['price_tax_excl'], ENT_QUOTES, 'UTF-8', true)),$_smarty_tpl ) );?>

																							<?php } else { ?>
																								<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0], array( array('price'=>htmlspecialchars((string)$_smarty_tpl->tpl_vars['roomDemand']->value['price_tax_excl'], ENT_QUOTES, 'UTF-8', true)),$_smarty_tpl ) );?>
...
?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['service']->value['quantity'];?>
																		...
																		<div class="col-xs-4">
																			<span class="pull-right"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0], array( array('price'=>$_smarty_tpl->tpl_vars['service']->value['total_price_tax_excl']),$_smarty_tpl ) );?>
</span>
																		</div>
																	</div>
																	<p></p>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<tfoot>
				<tr>
					<td colspan="7"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total cost:'),$_smarty_tpl ) );?>
</td>
...
?>
				<tr>
					...
					<td><a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCartRules'), ENT_QUOTES, 'UTF-8', true);?>
