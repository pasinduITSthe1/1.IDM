...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:18
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\modules\list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f28657b028_18357119',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '565e9a894c72bedb00b8a64010b0327d66a33cf9' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\modules\\list.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f28657b028_18357119 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.replace.php','function'=>'smarty_modifier_replace',),1=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.count.php','function'=>'smarty_modifier_count',),));
?>
									...
									<?php } else { ?>
										<?php if ((isset($_smarty_tpl->tpl_vars['module']->value->trusted)) && $_smarty_tpl->tpl_vars['module']->value->trusted) {?>
											<?php if ($_smarty_tpl->tpl_vars['module']->value->trusted == 2) {?>
												<a class="btn btn-success untrustedaddon" href="#" data-target="#moduleNotTrustedCountry" data-toggle="modal" data-link="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['module']->value->options['install_url'], ENT_QUOTES, 'UTF-8', true);?>
" data-module-name="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['module']->value->displayName, ENT_QUOTES, 'UTF-8', true);?>
">
...
">
											...
											<?php }?>
										<?php } else { ?>
										<a class="btn btn-success untrustedaddon" href="#" data-target="#moduleNotTrusted" data-toggle="modal" data-link="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['module']->value->options['install_url'], ENT_QUOTES, 'UTF-8', true);?>
" data-module-display-name="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['module']->value->displayName, ENT_QUOTES, 'UTF-8', true);?>
" data-module-name="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['module']->value->name, ENT_QUOTES, 'UTF-8', true);?>
...
/<?php echo $_smarty_tpl->tpl_vars['module']->value->name;?>
/<?php echo $_smarty_tpl->tpl_vars['module']->value->logo;
}?>" data-author-name="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['module']->value->author, ENT_QUOTES, 'UTF-8', true);?>
" data-author-uri="<?php if ((isset($_smarty_tpl->tpl_vars['module']->value->author_uri))) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['module']->value->author_uri, ENT_QUOTES, 'UTF-8', true);
}?>">
											<i class="icon-plus-sign-alt"></i>&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Install'),$_smarty_tpl ) );?>
