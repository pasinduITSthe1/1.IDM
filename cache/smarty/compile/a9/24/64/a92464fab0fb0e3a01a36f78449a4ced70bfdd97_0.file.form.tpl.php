...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:15
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\import\helpers\form\form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f2834879a1_75071636',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a92464fab0fb0e3a01a36f78449a4ced70bfdd97' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\import\\helpers\\form\\form.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f2834879a1_75071636 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_172356748168e4f2831d08b5_95492176', "leadin");
?>
</div>
<?php if ($_smarty_tpl->tpl_vars['module_confirmation']->value) {?>
<div class="alert alert-success clearfix">
	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Your .CSV file has been successfully imported to your website.'),$_smarty_tpl ) );?>
...
<div class="row">
	<div class="col-lg-8">
			...
			<hr />
			<form id="preview_import" action="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['current']->value, ENT_QUOTES, 'UTF-8', true);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				...
				<div class="form-group" id="csv_file_uploader">
					...
					<div class="col-lg-8">
						<input id="file" type="file" name="file" data-url="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['current']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;ajax=1&amp;action=uploadCsv" class="hide" />
						...
						<button class="btn btn-default csv-history-btn" type="button">
							<span class="csv-history-nb badge"><?php echo smarty_modifier_count($_smarty_tpl->tpl_vars['files_to_import']->value);?>
</span>
...
?>
							<tr >
								...
								<td>
									<div class="btn-group pull-right">
										<button type="button" data-filename="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['filename']->value, ENT_QUOTES, 'UTF-8', true);?>
...
" name="csv" id="csv_selected_value" />
						<div class="col-xs-8">
							<span id="csv_selected_filename"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['csv_selected']->value, ENT_QUOTES, 'UTF-8', true);?>
</span>
						</div>
						<div class="col-xs-4">
							<div class="btn-group pull-right">
					...
					<div class="col-lg-8">
						<span class="switch prestashop-switch fixed-width-lg">
							<input type="radio" name="convert" id="convert_on" value="1">
								<label for="convert_on"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Yes'),$_smarty_tpl ) );?>
</label>
							<input type="radio" name="convert" id="convert_off" value="0" checked="checked">
								<label for="convert_off"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No'),$_smarty_tpl ) );?>
</label>
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['separator_selected']->value, ENT_QUOTES, 'UTF-8', true);
} else { ?>;<?php }?>" />
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['multiple_value_separator_selected']->value, ENT_QUOTES, 'UTF-8', true);
} else { ?>,<?php }?>" />
						<div class="help-block"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'e.g. '),$_smarty_tpl ) );?>
 The Sunshine Luxury; News Paper:2.jpg, Gym:7.jpg</div>
					</div>
				</div>
				<hr />
				<div class="form-group">
					...
					<div class="col-lg-8">
						<span class="switch prestashop-switch fixed-width-lg">
							<input type="radio" name="truncate" id="truncate_on" value="1">
								<label for="truncate_on"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Yes'),$_smarty_tpl ) );?>
</label>
							<input type="radio" name="truncate" id="truncate_off" value="0" checked="checked">
								<label for="truncate_off"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No'),$_smarty_tpl ) );?>
</label>
							<a class="slide-button btn"></a>
						</span>
					</div>
...
">
					...
					<div class="col-lg-8">
						<span class="switch prestashop-switch fixed-width-lg">
							<input type="radio" name="match_ref" id="match_ref_on" value="1">
								<label for="match_ref_on"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Yes'),$_smarty_tpl ) );?>
</label>
							<input type="radio" name="match_ref" id="match_ref_off" value="0" checked="checked">
								<label for="match_ref_off"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No'),$_smarty_tpl ) );?>
</label>
							<a class="slide-button btn"></a>
						</span>
					</div>
					...
					<div class="col-lg-8">
						<span class="switch prestashop-switch fixed-width-lg">
							<input type="radio" name="regenerate" id="regenerate_on" value="1">
								<label for="regenerate_on"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Yes'),$_smarty_tpl ) );?>
</label>
							<input type="radio" name="regenerate" id="regenerate_off" value="0" checked="checked">
								<label for="regenerate_off"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No'),$_smarty_tpl ) );?>
</label>
							<a class="slide-button btn"></a>
						</span>
					</div>
				...
				<div class="form-group">
					<label for="forceIDs" class="control-label col-lg-4">
						<span data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'If you enable this option, your imported items\' ID number will be used as-is. If you do not enable this option, the imported ID number will be ignored, and QloApps will instead create auto-incremented ID numbers for all the imported items.'),$_smarty_tpl ) );?>
">
					...
					<div class="col-lg-8">
						<span class="switch prestashop-switch fixed-width-lg">
							<input type="radio" name="forceIDs" id="forceIDs_on" value="1">
								<label for="forceIDs_on"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Yes'),$_smarty_tpl ) );?>
</label>
							<input type="radio" name="forceIDs" id="forceIDs_off" value="0" checked="checked">
								<label for="forceIDs_off"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No'),$_smarty_tpl ) );?>
</label>
							<a class="slide-button btn"></a>
						</span>
					</div>
		...
		<div class="panel">
			...
			<div class="list-group">
				<a class="list-group-item _blank" href="../docs/csv_import/hotels_import.csv">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Sample Hotels file'),$_smarty_tpl ) );?>

				</a>
				<a class="list-group-item _blank" href="../docs/csv_import/room_types_import.csv">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Sample Room Types file'),$_smarty_tpl ) );?>

				</a>
				<a class="list-group-item _blank" href="../docs/csv_import/rooms_import.csv">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Sample Rooms file'),$_smarty_tpl ) );?>

				</a>
				<a class="list-group-item _blank" href="../docs/csv_import/service_products_import.csv">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Sample Service Products file'),$_smarty_tpl ) );?>
				...
				<a class="list-group-item _blank" href="../docs/csv_import/bookings_import.csv">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Sample Bookings file'),$_smarty_tpl ) );?>
				...
				if (data.result) {
					if (typeof data.result.file !== 'undefined') {
						if (typeof data.result.file.error !== 'undefined' && data.result.file.error != '')
							...
							row.find('a.csv-download-link').attr('href','<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['current']->value, ENT_QUOTES, 'UTF-8', true);?>
&token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
&csvfilename='+filename);
							row.find('a.csv-delete-link').attr('href','<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['current']->value, ENT_QUOTES, 'UTF-8', true);?>
&token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
...
<?php }
/* {block "leadin"} */
class Block_172356748168e4f2831d08b5_95492176 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'leadin' => 
  array (
    0 => 'Block_172356748168e4f2831d08b5_95492176',
  ),
);
