...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:08
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\cart_rules\conditions.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f27c652446_55775326',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '740152e6cbf6a89a81edd1485db6783c98889ee8' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\cart_rules\\conditions.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f27c652446_55775326 (Smarty_Internal_Template $_smarty_tpl) {
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['customerFilter']->value, ENT_QUOTES, 'UTF-8', true);
} elseif ((isset($_POST['customerFilter']))) {
echo htmlspecialchars((string)$_POST['customerFilter'], ENT_QUOTES, 'UTF-8', true);
}?>" />
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'date_from'), ENT_QUOTES, 'UTF-8', true);
} else {
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'date_to'), ENT_QUOTES, 'UTF-8', true);
} else {
...
<div class="form-group">
	<label class="control-label col-lg-3">
		<span class="label-tooltip" data-toggle="tooltip"
			title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'You can choose a minimum amount for the cart either with or without the taxes.'),$_smarty_tpl ) );?>
">
...
">&nbsp;<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['country']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</option>
								<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
">&nbsp;<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['carrier']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</option>
								<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['shops']->value['unselected'])+smarty_modifier_count($_smarty_tpl->tpl_vars['shops']->value['selected']) > 1) {?>
			<p class="checkbox">
				<label>
					<input type="checkbox" id="shop_restriction" name="shop_restriction" value="1" <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['shops']->value['unselected'])) {?>checked="checked"<?php }?> />
...
">&nbsp;<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['shop']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</option>
								<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
