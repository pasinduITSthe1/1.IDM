...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:27
  from 'C:\wamp64\www\1.IDM\themes\hotel-reservation-theme\scenes.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f28f0b85c8_74249202',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '747279c7bc943e370a3b34d6c9dd1b3d98a27683' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\themes\\hotel-reservation-theme\\scenes.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f28f0b85c8_74249202 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\function.math.php','function'=>'smarty_function_math',),1=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.count.php','function'=>'smarty_modifier_count',),));
...
$__foreach_scene_167_saved = $_smarty_tpl->tpl_vars['scene'];
?>
...
?>
			...
			<?php }?>
				<a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
...
" style="display:none;">
                	<div class="product-image-container">
						<?php if ((isset($_smarty_tpl->tpl_vars['imageIds']->value))) {?>
							<img class="img-responsive replace-2x" src="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['id_product'],$_smarty_tpl->tpl_vars['imageIds']->value,'home_default'), ENT_QUOTES, 'UTF-8', true);?>
" alt="" />
						<?php }?>
                    </div>
					<p class="product-name"><span class="product_name"><?php echo $_smarty_tpl->tpl_vars['product']->value['details']->name;?>
</span></p>
					<div class="description"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( preg_replace('!<[^>]*?>!', ' ', (string) $_smarty_tpl->tpl_vars['product']->value['details']->description_short),170,'...' ));?>
</div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php
$_smarty_tpl->tpl_vars['scene'] = $__foreach_scene_167_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	</div>
...
px;">&nbsp;</a>
		...
		<div id="scenes_list">
			<ul style="width:<?php echo smarty_function_math(array('equation'=>'(a*b + (a-1)*10)','a'=>smarty_modifier_count($_smarty_tpl->tpl_vars['scenes']->value),'b'=>$_smarty_tpl->tpl_vars['thumbSceneImageType']->value['width']),$_smarty_tpl);?>
...
$_smarty_tpl->tpl_vars['scene']->first = !$_smarty_tpl->tpl_vars['scene']->index;
$_smarty_tpl->tpl_vars['scene']->last = $_smarty_tpl->tpl_vars['scene']->iteration === $_smarty_tpl->tpl_vars['scene']->total;
$__foreach_scene_169_saved = $_smarty_tpl->tpl_vars['scene'];
?>
...
px; height:<?php echo $_smarty_tpl->tpl_vars['thumbSceneImageType']->value['height'];?>
px" title="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['scene']->value->name, ENT_QUOTES, 'UTF-8', true);?>
...
" class="scene_thumb">
						<img alt="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['scene']->value->name, ENT_QUOTES, 'UTF-8', true);?>
...
" />
		 	...
		 	<?php
$_smarty_tpl->tpl_vars['scene'] = $__foreach_scene_169_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		 	</ul>
		</div>
...
<?php $_block_plugin156 = isset($_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin156->addJsDefL(array('name'=>'i18n_scene_close'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin156->addJsDefL(array('name'=>'i18n_scene_close'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
