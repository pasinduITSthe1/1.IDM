...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:29
  from 'C:\wamp64\www\1.IDM\themes\hotel-reservation-theme\sitemap.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f2913d4a68_38920639',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '99308e142465abe0b40be1c19141744b472ebb5f' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\themes\\hotel-reservation-theme\\sitemap.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f2913d4a68_38920639 (Smarty_Internal_Template $_smarty_tpl) {
	...
	<div class="col-xs-12 col-sm-6">
		<div class="sitemap_block box">
    		...
    		<ul>
    			<li>
                    <a 
                    href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('new-products'), ENT_QUOTES, 'UTF-8', true);?>
" 
...
">
    			...
    			<?php if ($_smarty_tpl->tpl_vars['PS_DISPLAY_BEST_SELLERS']->value) {?>
        			<li>
                        <a 
                        href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('best-sales'), ENT_QUOTES, 'UTF-8', true);?>
" 
...
">
                ...
                <?php }?>
        			<li>
                        <a 
                        href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('prices-drop'), ENT_QUOTES, 'UTF-8', true);?>
" 
		...
		<div class="sitemap_block box">
    		...
    		<ul>
        		<?php if ($_smarty_tpl->tpl_vars['is_logged']->value) {?>
        			<li>
                        <a 
                        href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), ENT_QUOTES, 'UTF-8', true);?>
" 
                        rel="nofollow" 
...
">
        			...
        			<li>
                        <a 
                        href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('identity',true), ENT_QUOTES, 'UTF-8', true);?>
" 
                        rel="nofollow" 
...
">
        			...
        			<li>
                        <a 
                        href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('addresses',true), ENT_QUOTES, 'UTF-8', true);?>
" 
                        rel="nofollow" 
...
">
        			...
        			<?php if ($_smarty_tpl->tpl_vars['voucherAllowed']->value) {?>
                        <li>
                            <a 
                            href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('discount',true), ENT_QUOTES, 'UTF-8', true);?>
" 
                            rel="nofollow" 
...
">
        			...
        			<li>
                        <a 
                        href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('history',true), ENT_QUOTES, 'UTF-8', true);?>
" 
                        rel="nofollow"
...
" >
        		...
        		<?php } else { ?>
        			<li>
                        <a 
                        href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'UTF-8', true);?>
" 
                        rel="nofollow"
...
" title="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['categoriesTree']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
"></a>
            </div>
            <ul class="tree">
...
$__foreach_child_185_saved = $_smarty_tpl->tpl_vars['child'];
?>
...
?>
                    <?php }?>
                <?php
$_smarty_tpl->tpl_vars['child'] = $__foreach_child_185_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div class="col-xs-12 col-sm-6">
		<div class="sitemap_block box">
            ...
            <ul>
            	<li>
                    <a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['categoriescmsTree']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['categoriescmsTree']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
">
                        <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['categoriescmsTree']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
$_smarty_tpl->tpl_vars['child']->iteration++;
$_smarty_tpl->tpl_vars['child']->last = $_smarty_tpl->tpl_vars['child']->iteration === $_smarty_tpl->tpl_vars['child']->total;
$__foreach_child_186_saved = $_smarty_tpl->tpl_vars['child'];
?>
                        <?php if (((isset($_smarty_tpl->tpl_vars['child']->value['children'])) && smarty_modifier_count($_smarty_tpl->tpl_vars['child']->value['children']) > 0) || smarty_modifier_count($_smarty_tpl->tpl_vars['child']->value['cms']) > 0) {?>
...
?>
                        <?php }?>
                    <?php
$_smarty_tpl->tpl_vars['child'] = $__foreach_child_186_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                <?php }?>
                <?php
...
?>
                    <li>
                        <a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['cms']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
