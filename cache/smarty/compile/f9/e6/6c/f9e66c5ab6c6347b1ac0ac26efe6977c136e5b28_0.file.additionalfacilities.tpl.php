...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:35
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\products\additionalfacilities.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f297677083_69939375',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f9e66c5ab6c6347b1ac0ac26efe6977c136e5b28' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\products\\additionalfacilities.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f297677083_69939375 (Smarty_Internal_Template $_smarty_tpl) {
 ...
 <?php if ((isset($_smarty_tpl->tpl_vars['product']->value->id)) && $_smarty_tpl->tpl_vars['product']->value->id) {?>
    ...
    <div class="panel">
        ...
        <div class="alert alert-info">
            <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'To create new additional facilities please visit'),$_smarty_tpl ) );?>
...
?>
                            ...
                            <?php if ((isset($_smarty_tpl->tpl_vars['demand']->value['adv_option'])) && $_smarty_tpl->tpl_vars['demand']->value['adv_option']) {?>
                                <?php $_smarty_tpl->_assignInScope('rowspan', smarty_modifier_count($_smarty_tpl->tpl_vars['demand']->value['adv_option']));?>
...
">
                                                <input class="selected_demand" type="checkbox" name="selected_demand[]" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['demand']->value['id_global_demand'], ENT_QUOTES, 'UTF-8', true);?>
" <?php if ((isset($_smarty_tpl->tpl_vars['selectedDemands']->value[$_smarty_tpl->tpl_vars['demand']->value['id_global_demand']]))) {?>checked<?php }?> />
                                                <input type="hidden" name="demand_price_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['demand']->value['id_global_demand'], ENT_QUOTES, 'UTF-8', true);?>
" value="<?php if ((isset($_smarty_tpl->tpl_vars['selectedDemands']->value[$_smarty_tpl->tpl_vars['demand']->value['id_global_demand']]['price']))) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['selectedDemands']->value[$_smarty_tpl->tpl_vars['demand']->value['id_global_demand']]['price'], ENT_QUOTES, 'UTF-8', true);
} elseif ((isset($_smarty_tpl->tpl_vars['demand']->value['price']))) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['demand']->value['price'], ENT_QUOTES, 'UTF-8', true);
}?>"/>
                                            </td>
                                            <td rowspan="<?php echo $_smarty_tpl->tpl_vars['rowspan']->value;?>
">
                                                <a target="blank" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminRoomTypeGlobalDemand'), ENT_QUOTES, 'UTF-8', true);?>
&amp;id_global_demand=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['demand']->value['id_global_demand'], ENT_QUOTES, 'UTF-8', true);?>
&amp;updatehtl_room_type_global_demand"><i class="icon-external-link-sign"></i></a> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['demand']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
">
                                            <div class="input-group price_input" <?php if (!(isset($_smarty_tpl->tpl_vars['selectedDemands']->value[$_smarty_tpl->tpl_vars['demand']->value['id_global_demand']]))) {?>style="display:none"<?php }?>>
                                                <span class="input-group-addon"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['defaultcurrencySign']->value, ENT_QUOTES, 'UTF-8', true);?>
</span>
                                                <input type="text" name="option_price_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['option']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['selectedDemands']->value[$_smarty_tpl->tpl_vars['demand']->value['id_global_demand']]['adv_option'][$_smarty_tpl->tpl_vars['option']->value['id']]['price'], ENT_QUOTES, 'UTF-8', true);
} else {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['option']->value['price'], ENT_QUOTES, 'UTF-8', true);
}?>"/>
                                            </div>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0], array( array('price'=>$_prefixVariable22,'currency'=>$_smarty_tpl->tpl_vars['idDefaultcurrency']->value),$_smarty_tpl ) );?>
...
">
                                            <div class="input-group price_input" <?php if (!(isset($_smarty_tpl->tpl_vars['selectedDemands']->value[$_smarty_tpl->tpl_vars['demand']->value['id_global_demand']]))) {?>style="display:none"<?php }?>>
                                                ...
                                                <input type="text" name="demand_price_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['demand']->value['id_global_demand'], ENT_QUOTES, 'UTF-8', true);?>
"
                                                value="<?php if ((isset($_smarty_tpl->tpl_vars['selectedDemands']->value[$_smarty_tpl->tpl_vars['demand']->value['id_global_demand']]['price']))) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['selectedDemands']->value[$_smarty_tpl->tpl_vars['demand']->value['id_global_demand']]['price'], ENT_QUOTES, 'UTF-8', true);
} elseif ((isset($_smarty_tpl->tpl_vars['demand']->value['price']))) {
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0], array( array('price'=>$_prefixVariable23,'currency'=>$_smarty_tpl->tpl_vars['idDefaultcurrency']->value),$_smarty_tpl ) );?>
