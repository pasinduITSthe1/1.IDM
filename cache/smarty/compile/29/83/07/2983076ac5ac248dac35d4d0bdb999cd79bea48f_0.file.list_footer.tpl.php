...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:10
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\countries\helpers\list\list_footer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f27ea4aa60_64173926',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2983076ac5ac248dac35d4d0bdb999cd79bea48f' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\countries\\helpers\\list\\list_footer.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f27ea4aa60_64173926 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
			...
			<div class="row">
				...
				<?php if ($_smarty_tpl->tpl_vars['bulk_actions']->value) {?>
					<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['bulk_actions']->value) > 1) {?>
...
?>
										<?php if ($_smarty_tpl->tpl_vars['params']->value['text'] == 'divider') {?>
											<option value="" disabled="disabled" class="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['params']->value['text'], ENT_QUOTES, 'UTF-8', true);?>
">--</option>
										<?php } else { ?>
...
"<?php }?>><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['params']->value['text'], ENT_QUOTES, 'UTF-8', true);?>
</option>
										<?php }?>
									<?php
}
	...
	function loadZones()
	{
		if (!loaded)
		{
			$.ajax({
				...
				data: 'getZones=true&token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
',
				async : true,
				cache: false,
				dataType: 'json',
