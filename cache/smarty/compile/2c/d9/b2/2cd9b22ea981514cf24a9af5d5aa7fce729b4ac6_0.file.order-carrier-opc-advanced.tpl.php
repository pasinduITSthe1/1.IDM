...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:16
  from 'C:\wamp64\www\1.IDM\themes\hotel-reservation-theme\order-carrier-opc-advanced.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f284120685_36529812',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2cd9b22ea981514cf24a9af5d5aa7fce729b4ac6' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\themes\\hotel-reservation-theme\\order-carrier-opc-advanced.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f284120685_36529812 (Smarty_Internal_Template $_smarty_tpl) {
...
$__foreach_option_73_saved = $_smarty_tpl->tpl_vars['option'];
?>
...
$__foreach_carrier_74_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
...
"/>
                                                        ...
                                                        <?php }?>
                                                    <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_74_saved;
}
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_75_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
                                                        ...
                                                        <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_75_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
$__foreach_product_76_saved = $_smarty_tpl->tpl_vars['product'];
?>
...
if (!$_smarty_tpl->tpl_vars['product']->last) {?>,&nbsp;<?php } else { ?>)<?php }
                                                            ...
                                                            <?php
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_76_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        <?php }?>
                                                    </td>
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_77_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
...
$_smarty_tpl->tpl_vars['product']->index++;
$_smarty_tpl->tpl_vars['product']->last = $_smarty_tpl->tpl_vars['product']->iteration === $_smarty_tpl->tpl_vars['product']->total;
$__foreach_product_78_saved = $_smarty_tpl->tpl_vars['product'];
?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['product']->index == 4) {?>
                                                                            <acronym title="
                                                                        <?php }?>
...
if (!$_smarty_tpl->tpl_vars['product']->last) {?>,&nbsp;<?php } else { ?>)<?php }
                                                                    ...
                                                                    <?php
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_78_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                                <?php }?>
                                                            </td>
                                                    ...
                                                    <?php }?>
                                                <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_77_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                            </table>
                                        <?php }?>
                            ...
                            <?php
$_smarty_tpl->tpl_vars['option'] = $__foreach_option_73_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
?>
                        <?php $_smarty_tpl->_assignInScope('errors', smarty_modifier_explode(' ',''));?>
...
$__foreach_address_79_saved = $_smarty_tpl->tpl_vars['address'];
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <?php }?>
                                <?php
$_smarty_tpl->tpl_vars['address'] = $__foreach_address_79_saved;
}
...
$_block_repeat=true;
echo $_block_plugin67->addJsDefL(array('name'=>'msg_order_carrier'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin67->addJsDefL(array('name'=>'msg_order_carrier'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
