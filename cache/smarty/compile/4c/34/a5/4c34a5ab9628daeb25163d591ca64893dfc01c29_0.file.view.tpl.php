...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:11
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\customers\helpers\view\view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f27fb815e1_24697352',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4c34a5ab9628daeb25163d591ca64893dfc01c29' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\customers\\helpers\\view\\view.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f27fb815e1_24697352 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_47482246468e4f27f09fc61_80285487', "override_tpl");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "helpers/view/view.tpl");
}
/* {block "override_tpl"} */
class Block_47482246468e4f27f09fc61_80285487 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'override_tpl' => 
  array (
    0 => 'Block_47482246468e4f27f09fc61_80285487',
  ),
);
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Unknown'),$_smarty_tpl ) );
					...
					<div class="row">
						...
						<div class="col-lg-9">
							<p class="form-control-static"><?php echo $_smarty_tpl->tpl_vars['customer']->value->phone;?>
</p>
						</div>
					</div>
					<div class="row">
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Never'),$_smarty_tpl ) );
					...
					<div class="row">
						...
						<div class="col-lg-9">
							<p class="form-control-static">
								<?php if (!$_smarty_tpl->tpl_vars['customer']->value->deleted) {?>
									...
									<?php }?>
								<?php } elseif ($_smarty_tpl->tpl_vars['customer']->value->deleted == Customer::STATUS_BANNED) {?>
									<span class="label label-warning">
										<i class="icon-remove"></i>
										<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Banned'),$_smarty_tpl ) );?>

									</span>
								<?php } elseif ($_smarty_tpl->tpl_vars['customer']->value->deleted == Customer::STATUS_DELETED) {?>
									<span class="label label-danger">
										<i class="icon-remove"></i>
										<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Deleted'),$_smarty_tpl ) );?>
...
" />
 ...
 <span class="badge"><?php echo count($_smarty_tpl->tpl_vars['orders']->value);?>
				...
				<?php if ($_smarty_tpl->tpl_vars['orders']->value && count($_smarty_tpl->tpl_vars['orders']->value)) {?>
					...
					<?php if ($_smarty_tpl->tpl_vars['count_ok']->value || $_smarty_tpl->tpl_vars['count_ko']->value) {?>
						<div class="nav nav-tabs">
							<ul class="nav nav-tabs">
								<li <?php if ($_smarty_tpl->tpl_vars['count_ok']->value) {?>class="active"<?php }?>>
								...
								<li <?php if (!$_smarty_tpl->tpl_vars['count_ok']->value && $_smarty_tpl->tpl_vars['count_ko']->value) {?>class="active"<?php }?>>
							...
							<div class="tab-content panel">
								<div class="tab-pane <?php if ($_smarty_tpl->tpl_vars['count_ok']->value) {?>active<?php }?>" id="valid_orders">
									<div class="row">
										<div class="col-lg-5">
											<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total amount received: %s','sprintf'=>$_smarty_tpl->tpl_vars['total_ok']->value),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
									...
									<?php } else { ?>
										<p class="text-muted text-center">
											<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No valid order found!!'),$_smarty_tpl ) );?>

										</p>
									<?php }?>
								</div>

								<div class="tab-pane <?php if (!$_smarty_tpl->tpl_vars['count_ok']->value && $_smarty_tpl->tpl_vars['count_ko']->value) {?>active<?php }?>" id="invalid_orders">
									<div class="row">
										<div class="col-lg-5">
											<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Order total: %s','sprintf'=>$_smarty_tpl->tpl_vars['total_ko']->value),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
									...
									<?php } else { ?>
										<p class="text-muted text-center">
											<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No invalid order found!!'),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['products']->value && count($_smarty_tpl->tpl_vars['products']->value)) {?>
				<div class="panel">
					<div class="panel-heading">
						<i class="icon-archive"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Room types and services'),$_smarty_tpl ) );?>
 <span class="badge"><?php echo count($_smarty_tpl->tpl_vars['products']->value);?>
</span>
					</div>
					<div class="nav nav-tabs">
						<ul class="nav nav-tabs">
							<?php $_smarty_tpl->_assignInScope('count_room_types', count($_smarty_tpl->tpl_vars['purchasedRoomTypes']->value));?>
							<?php $_smarty_tpl->_assignInScope('count_services', count($_smarty_tpl->tpl_vars['purchasedServices']->value));?>
							<?php if ($_smarty_tpl->tpl_vars['count_room_types']->value) {?>
								<li class="active">
									<a data-toggle="tab" href="#purchased_room_types">
										<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Room Types'),$_smarty_tpl ) );?>

										<span class="label label-success"><?php echo $_smarty_tpl->tpl_vars['count_room_types']->value;?>
</span>
									</a>
								</li>
							<?php }?>
							<?php if ($_smarty_tpl->tpl_vars['count_services']->value) {?>
								<li <?php if (!$_smarty_tpl->tpl_vars['count_room_types']->value) {?> class="active" <?php }?>>
									<a data-toggle="tab" href="#purchased_services">
										<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Services:'),$_smarty_tpl ) );?>

										<span class="label label-success"><?php echo $_smarty_tpl->tpl_vars['count_services']->value;?>
</span>
									</a>
								</li>
							<?php }?>
							...
							<?php if ($_smarty_tpl->tpl_vars['count_room_types']->value) {?>
								<div class="tab-pane active" id="purchased_room_types">
									<table class="table">
										<thead>
											<tr>
												<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'ID Order'),$_smarty_tpl ) );?>
</span></th>
												...
												<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Nights booked'),$_smarty_tpl ) );?>
</span></th>
												<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Booking Date'),$_smarty_tpl ) );?>
</span></th>
											</tr>
										</thead>
										<tbody>
											<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['purchasedRoomTypes']->value, 'product', false, 'key');
...
&amp;vieworder&amp;token=<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getAdminToken'][0], array( array('tab'=>'AdminOrders'),$_smarty_tpl ) );?>
">
														#<?php echo $_smarty_tpl->tpl_vars['product']->value['id_order'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
							...
							<?php }?>
							<?php if ($_smarty_tpl->tpl_vars['count_services']->value) {?>
								<div class="tab-pane <?php if (!$_smarty_tpl->tpl_vars['count_room_types']->value) {?>active<?php }?>" id="purchased_services">
									<table class="table">
										<thead>
											<tr>
												<th><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'ID Order'),$_smarty_tpl ) );?>
										...
										<tbody>
											<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['purchasedServices']->value, 'product', false, 'key');
$_smarty_tpl->tpl_vars['product']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['product']->value) {
$_smarty_tpl->tpl_vars['product']->do_else = false;
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<div class="panel">
				<div class="panel-heading">
					<i class="icon-eye"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Viewed room types'),$_smarty_tpl ) );?>
...
?>
						<tr onclick="document.location = '<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['p']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
'">
							<td><?php echo $_smarty_tpl->tpl_vars['p']->value['id'];?>
</td>
							<td><a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['p']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <span class="badge"><?php echo count($_smarty_tpl->tpl_vars['messages']->value);?>
				...
				<?php if (count($_smarty_tpl->tpl_vars['messages']->value)) {?>
					<table class="table">
						<thead>
							<th class="fixed-width-sm"><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Status'),$_smarty_tpl ) );?>
</span></th>
							...
							<th class="fixed-width-lg"><span class="title_box"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Sent on'),$_smarty_tpl ) );?>
</span></th>
						</thead>
						<?php
...
?>
							<tr>
								<td><?php if ($_smarty_tpl->tpl_vars['message']->value['status'] == CustomerThread::QLO_CUSTOMER_THREAD_STATUS_OPEN) {?>
										<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Open'),$_smarty_tpl ) );?>

									<?php } elseif ($_smarty_tpl->tpl_vars['message']->value['status'] == CustomerThread::QLO_CUSTOMER_THREAD_STATUS_CLOSED) {?>
										<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Closed'),$_smarty_tpl ) );?>

									<?php } elseif ($_smarty_tpl->tpl_vars['message']->value['status'] == CustomerThread::QLO_CUSTOMER_THREAD_STATUS_PENDING1) {?>
										<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Pending 1'),$_smarty_tpl ) );?>

									<?php } elseif ($_smarty_tpl->tpl_vars['message']->value['status'] == CustomerThread::QLO_CUSTOMER_THREAD_STATUS_PENDING2) {?>
										<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Pending 2'),$_smarty_tpl ) );?>
...
">
									...
									<a onclick="return confirm('<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Are you sure?'),$_smarty_tpl ) );?>
')" href="?tab=AdminCartRules&amp;id_cart_rule=<?php echo intval($_smarty_tpl->tpl_vars['discount']->value['id_cart_rule']);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<div class="panel">
				<div class="panel-heading">
					...
					<a class="btn btn-default pull-right" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['current']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;updatecustomer&amp;id_customer=<?php echo intval($_smarty_tpl->tpl_vars['customer']->value->id);?>
&amp;token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);?>
">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['customer_guests']->value && count($_smarty_tpl->tpl_vars['customer_guests']->value)) {?>
				<div class="panel">
					<div class="panel-heading">
						<i class="icon-user"></i>
						<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Customer Guests'),$_smarty_tpl ) );?>

						<span class="badge customer-guests-count"><?php echo count($_smarty_tpl->tpl_vars['customer_guests']->value);?>
</span>
					</div>
					<table class="table customer-guests">
						<thead>
							<tr>
								<th><span class="title_box "><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Email'),$_smarty_tpl ) );?>
</span></th>
								<th><span class="title_box "><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'First name'),$_smarty_tpl ) );?>
</span></th>
								<th><span class="title_box "><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Last name'),$_smarty_tpl ) );?>
</span></th>
								<th><span class="title_box "><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'phone'),$_smarty_tpl ) );?>
</span></th>
								<th colspan="2"><span class="title_box "><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Actions'),$_smarty_tpl ) );?>
</span></th>
							</tr>
						</thead>
						<tbody>
							<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['customer_guests']->value, 'customer_guest', false, 'key');
$_smarty_tpl->tpl_vars['customer_guest']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['customer_guest']->value) {
$_smarty_tpl->tpl_vars['customer_guest']->do_else = false;
?>
								<tr class="customer_guest_detail_<?php echo $_smarty_tpl->tpl_vars['customer_guest']->value['id_customer_guest_detail'];?>
 customer_guest_details">
									<td><?php echo $_smarty_tpl->tpl_vars['customer_guest']->value['email'];?>
</td>
									<td><?php echo $_smarty_tpl->tpl_vars['customer_guest']->value['firstname'];?>
</td>
									<td><?php echo $_smarty_tpl->tpl_vars['customer_guest']->value['lastname'];?>
</td>
									<td><?php echo $_smarty_tpl->tpl_vars['customer_guest']->value['phone'];?>
</td>
									<td><a href="#" class="edit-customer-guest-detail" data-id_customer_guest_detail="<?php echo $_smarty_tpl->tpl_vars['customer_guest']->value['id_customer_guest_detail'];?>
"><i class="icon-pencil"></i></a></td>
									<td><a href="#" class="delete-customer-guest-detail" data-id_customer_guest_detail="<?php echo $_smarty_tpl->tpl_vars['customer_guest']->value['id_customer_guest_detail'];?>
