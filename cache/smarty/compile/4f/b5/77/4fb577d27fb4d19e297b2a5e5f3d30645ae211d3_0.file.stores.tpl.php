...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:29
  from 'C:\wamp64\www\1.IDM\themes\hotel-reservation-theme\stores.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f29171de92_56559910',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4fb577d27fb4d19e297b2a5e5f3d30645ae211d3' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\themes\\hotel-reservation-theme\\stores.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f29171de92_56559910 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.count.php','function'=>'smarty_modifier_count',),1=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.explode.php','function'=>'smarty_modifier_explode',),2=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.replace.php','function'=>'smarty_modifier_replace',),));
?>
...
<?php if ($_smarty_tpl->tpl_vars['simplifiedStoresDiplay']->value) {?>
	<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['stores']->value)) {?>
		<p class="store-title">
			<strong class="dark">
...
-medium_default.jpg" alt="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['store']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
"/>
					...
					<td class="name">
						<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['store']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
"<?php }?>>
	                            <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['addresses_formated']->value[$_smarty_tpl->tpl_vars['id_store']->value]['formated'][smarty_modifier_replace($_smarty_tpl->tpl_vars['key']->value,',','')], ENT_QUOTES, 'UTF-8', true);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['store']->value['phone'], ENT_QUOTES, 'UTF-8', true);
}?>
 ...
 <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['store']->value['fax'], ENT_QUOTES, 'UTF-8', true);
}?>
 ...
 <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['store']->value['email'], ENT_QUOTES, 'UTF-8', true);
}?>
						<?php if ($_smarty_tpl->tpl_vars['store']->value['note']) {?><br/><br/><?php echo nl2br((string) htmlspecialchars((string)$_smarty_tpl->tpl_vars['store']->value['note'], ENT_QUOTES, 'UTF-8', true), (bool) 1);
}?>
					</td>
...
$_block_repeat=true;
echo $_block_plugin159->addJsDefL(array('name'=>'translation_1'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin159->addJsDefL(array('name'=>'translation_1'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin160->addJsDefL(array('name'=>'translation_2'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin160->addJsDefL(array('name'=>'translation_2'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
...
$_block_repeat=true;
echo $_block_plugin161->addJsDefL(array('name'=>'translation_3'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin161->addJsDefL(array('name'=>'translation_3'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
$_block_plugin162 = isset($_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0] : null;
if (!is_callable(array($_block_plugin162, 'addJsDefL'))) {
throw new SmartyException('block tag \'addJsDefL\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('addJsDefL', array('name'=>'translation_4'));
$_block_repeat=true;
echo $_block_plugin162->addJsDefL(array('name'=>'translation_4'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin162->addJsDefL(array('name'=>'translation_4'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
$_block_plugin163 = isset($_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0] : null;
if (!is_callable(array($_block_plugin163, 'addJsDefL'))) {
throw new SmartyException('block tag \'addJsDefL\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('addJsDefL', array('name'=>'translation_5'));
$_block_repeat=true;
echo $_block_plugin163->addJsDefL(array('name'=>'translation_5'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin163->addJsDefL(array('name'=>'translation_5'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
$_block_plugin164 = isset($_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0] : null;
if (!is_callable(array($_block_plugin164, 'addJsDefL'))) {
throw new SmartyException('block tag \'addJsDefL\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('addJsDefL', array('name'=>'translation_6'));
$_block_repeat=true;
echo $_block_plugin164->addJsDefL(array('name'=>'translation_6'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
...
$_block_repeat=false;
echo $_block_plugin164->addJsDefL(array('name'=>'translation_6'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
