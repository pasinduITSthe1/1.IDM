...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:26
  from 'C:\wamp64\www\1.IDM\themes\hotel-reservation-theme\products-comparison.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f28ea82121_87910451',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7a19247048e6fad598d1a45a4e3647fd1309f70e' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\themes\\hotel-reservation-theme\\products-comparison.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f28ea82121_87910451 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\function.math.php','function'=>'smarty_function_math',),1=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\function.cycle.php','function'=>'smarty_function_cycle',),2=>array('file'=>'C:\\wamp64\\www\\1.IDM\\tools\\smarty\\plugins\\modifier.count.php','function'=>'smarty_modifier_count',),));
...
">
						<div class="remove">
							<a class="cmp_remove" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('products-comparison',true), ENT_QUOTES, 'UTF-8', true);?>
...
">
						...
						<div class="product-image-block">
							<a
							class="product_image"
							href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
"
							title="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
">
								<img
								class="img-responsive"
								src="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['product']->value->id_image,'home_default'), ENT_QUOTES, 'UTF-8', true);?>
"
								alt="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
" />
							</a>
							<?php if ((isset($_smarty_tpl->tpl_vars['product']->value->new)) && $_smarty_tpl->tpl_vars['product']->value->new == 1) {?>
								<a class="new-box" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
">
							...
							<?php if ((isset($_smarty_tpl->tpl_vars['product']->value->show_price)) && $_smarty_tpl->tpl_vars['product']->value->show_price && !(isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) && !$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
								<?php if ($_smarty_tpl->tpl_vars['product']->value->on_sale) {?>
									<a class="sale-box" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
">
						...
						<h5>
							<a class="product-name"	href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars((string)call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value->name,32,'...' )), ENT_QUOTES, 'UTF-8', true);?>
">
								<?php echo htmlspecialchars((string)call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value->name,45,'...' )), ENT_QUOTES, 'UTF-8', true);?>
...
%
 ...
 <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'per %s','sprintf'=>htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->unity, ENT_QUOTES, 'UTF-8', true)),$_smarty_tpl ) );?>
						...
						<div class="product_desc">
							<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( preg_replace('!<[^>]*?>!', ' ', (string) $_smarty_tpl->tpl_vars['product']->value->description_short),60,'...' ));?>
									...
									<span class="availability_value"<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity <= 0) {?> class="warning-inline"<?php }?>>
										<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity <= 0) {?>
											<?php if ($_smarty_tpl->tpl_vars['product']->value->allow_oosp) {?>
												<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->available_later, ENT_QUOTES, 'UTF-8', true);?>
											...
											<?php }?>
										<?php } else { ?>
											<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->available_now, ENT_QUOTES, 'UTF-8', true);?>
...
" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,NULL,"qty=1&amp;id_product=".((string)$_smarty_tpl->tpl_vars['product']->value->id)."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)."&amp;add"), ENT_QUOTES, 'UTF-8', true);?>
...
">
										...
										<?php }?>
									<?php }?>
									<a class="button lnk_view btn btn-default" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
...
?>
 ...
 feature-name" >
							<strong><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['feature']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</strong>
						</td>
						<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['products']->value, 'product', false, NULL, 'for_products', array (
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['tab']->value[$_smarty_tpl->tpl_vars['feature_id']->value], ENT_QUOTES, 'UTF-8', true);
}?></td>
							<?php } else { ?>
								<td class="<?php echo $_smarty_tpl->tpl_vars['classname']->value;?>
 comparison_infos product-<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			<?php } else { ?>
				<tr>
					<td></td>
					<td colspan="<?php echo smarty_modifier_count($_smarty_tpl->tpl_vars['products']->value);?>
