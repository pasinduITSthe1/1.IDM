...
/* Smarty version 4.5.5, created on 2025-10-07 10:59:15
  from 'C:\wamp64\www\1.IDM\admin\themes\default\template\controllers\information\helpers\view\view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f283acbc14_59492702',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ac78e381b84e78233fbcaf7ffb0cc36b7b10a6bd' => 
    array (
      0 => 'C:\\wamp64\\www\\1.IDM\\admin\\themes\\default\\template\\controllers\\information\\helpers\\view\\view.tpl',
      1 => 1751632538,
      2 => 'file',
    ),
  ),
...
function content_68e4f283acbc14_59492702 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_93179990568e4f283816f62_91940021', "override_tpl");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "helpers/view/view.tpl");
}
/* {block "override_tpl"} */
class Block_93179990568e4f283816f62_91940021 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'override_tpl' => 
  array (
    0 => 'Block_93179990568e4f283816f62_91940021',
  ),
);
	...
	<div class="row">
		<div class="col-lg-6">
			...
			<div class="panel">
				...
				<?php if (Tools::strlen($_smarty_tpl->tpl_vars['uname']->value) > 0) {?>
				<p>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['uname']->value, ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['version']->value['server'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['version']->value['php'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['version']->value['memory_limit'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['version']->value['max_execution_time'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['database']->value['version'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['database']->value['server'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['database']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['database']->value['user'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['database']->value['prefix'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['database']->value['engine'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['database']->value['driver'], ENT_QUOTES, 'UTF-8', true);?>
		...
		<div class="col-lg-6">
			<div class="panel">
				<h3>
					<i class="icon-info"></i>
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Website information'),$_smarty_tpl ) );?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['shop']->value['qloappsV'], ENT_QUOTES, 'UTF-8', true);?>

				</p>
				<p>
					<strong><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Website URL:'),$_smarty_tpl ) );?>
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['shop']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['shop']->value['theme'], ENT_QUOTES, 'UTF-8', true);?>
...
:</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['smtp']->value['server'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['smtp']->value['encryption'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['smtp']->value['port'], ENT_QUOTES, 'UTF-8', true);?>
...
</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['user_agent']->value, ENT_QUOTES, 'UTF-8', true);?>
