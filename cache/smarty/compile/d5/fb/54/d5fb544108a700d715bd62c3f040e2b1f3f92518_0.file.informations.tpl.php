...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68e4f28bd81094_72167102',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd5fb544108a700d715bd62c3f040e2b1f3f92518' => 
    array (
  ...
  array (
    ...
    'file:controllers/normal_products/textarea_lang.tpl' => 1,
  ),
),false)) {
function content_68e4f28bd81094_72167102 (Smarty_Internal_Template $_smarty_tpl) {
...
>
    	    ...
    	    <div class="form-group" id="associated_hotel_tree" <?php if (($_smarty_tpl->tpl_vars['product']->value->selling_preference_type != Product::SELLING_PREFERENCE_HOTEL_STANDALONE && $_smarty_tpl->tpl_vars['product']->value->selling_preference_type != Product::SELLING_PREFERENCE_HOTEL_STANDALONE_AND_WITH_ROOM_TYPE)) {?>style="display:none;"<?php }?>>
...
?></span></div>
		<label class="control-label col-lg-2" for="hotel_block">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Select hotels for which this service will be available.'),$_smarty_tpl ) );?>
">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Associated Hotels'),$_smarty_tpl ) );?>
	...
	<div class="form-group" id="associated_hotel_rooms_tree" <?php if (($_smarty_tpl->tpl_vars['product']->value->selling_preference_type != Product::SELLING_PREFERENCE_WITH_ROOM_TYPE && $_smarty_tpl->tpl_vars['product']->value->selling_preference_type != Product::SELLING_PREFERENCE_HOTEL_STANDALONE_AND_WITH_ROOM_TYPE && $_smarty_tpl->tpl_vars['product']->value->selling_preference_type != 0)) {?>style="display:none;"<?php }?>>
		<div class="col-lg-1"><span class="pull-right"><?php $_smarty_tpl->_subTemplateRender("file:controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('field'=>"category_box",'type'=>"category_box"), 0, true);
?></span></div>
...
">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Associated Room Types'),$_smarty_tpl ) );?>

			</span>
		</label>
		<div class="col-lg-9">
			<div id="hotel_room_block">
				<?php echo $_smarty_tpl->tpl_vars['hotel_room_tree']->value;?>

			</div>
		</div>
	</div>
	<div class="form-group" id="auto_add_to_cart_container" <?php if ($_smarty_tpl->tpl_vars['product']->value->selling_preference_type != Product::SELLING_PREFERENCE_WITH_ROOM_TYPE && $_smarty_tpl->tpl_vars['product']->value->selling_preference_type != 0) {?>style="display:none;"<?php }?>>
...
?></span></div>
	...
	<div id="allow_multiple_quantity_container" <?php if ($_smarty_tpl->tpl_vars['product']->value->auto_add_to_cart && $_smarty_tpl->tpl_vars['product']->value->isAssociatedToShop()) {?>style="display:none;"<?php }?>>
		<div class="form-group">
...
">
		...
		<div id="max_quantity_container" <?php if (($_smarty_tpl->tpl_vars['product']->value->auto_add_to_cart && $_smarty_tpl->tpl_vars['product']->value->isAssociatedToShop()) || !$_smarty_tpl->tpl_vars['product']->value->allow_multiple_quantity) {?>style="display:none;"<?php }?>>
			<div class="form-group">
...
">
				...
				<div class="col-lg-3">
					<input type="text" id="max_quantity" name="max_quantity" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->max_quantity, ENT_QUOTES, 'UTF-8', true);?>
" />
				</div>
			</div>
			<div class="form-group">
...
">
		...
		<div class="col-lg-9">
			<?php $_smarty_tpl->_subTemplateRender("file:controllers/normal_products/textarea_lang.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('languages'=>$_smarty_tpl->tpl_vars['languages']->value,'input_name'=>'description_short','input_value'=>$_smarty_tpl->tpl_vars['product']->value->description_short,'maxlength'=>$_smarty_tpl->tpl_vars['PS_SHORT_DESC_LIMIT']->value), 0, false);
?>
		</div>
	</div>
